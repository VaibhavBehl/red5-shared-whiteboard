...
//!!
import com.free.whiteboard.ShapeDrawingSO;
import com.free.whiteboard.TextDrawingSO;
...
//!!
		public var shapeDrawingSO:ShapeDrawingSO;
		public var textDrawingSO:TextDrawingSO;
...
///////////////////////////////////////////////////This function will connect the  application to red5 server
	public function connectServer()
	{
		...
		connect_NC.onStatus = function(info)
		{
			switch(info.code)
			{
				case "NetConnection.Connect.Success":
					...
					_global.whiteboard.evtHandler.lineDrawingSO.addLineDrawingSO(this,_global.whiteboard.evtHandler.clientId);
					
					_global.whiteboard.evtHandler.shapeDrawingSO = new ShapeDrawingSO();
                                        _global.whiteboard.evtHandler.shapeDrawingSO.addShapeDrawingSO(this,_global.whiteboard.evtHandler.clientId);

                                        _global.whiteboard.evtHandler.textDrawingSO = new TextDrawingSO();
                                        _global.whiteboard.evtHandler.textDrawingSO.addTextDrawingSO(this,_global.whiteboard.evtHandler.clientId);
					break;
		...
		//connect_NC.connect("rtmp://"+server_ip.text+"/Whiteboard", clientId);
		
		_global.whiteboard.connect_BTN._alpha = 100;
		_global.whiteboard.disconnect_BTN._alpha = 50;
	}
	
/////////////////////////////////////////////////This function will disconnect the application to red5 server
...
//////////////////////////////////////////////This funtion is responsible for free hand drawing in whiteboard
...
//////////////////////////////////////////This function will draw line on whiteboard and send event to server
...
////////////////////////////////////////This function will draw circle on whiteboard and send event to server
...
/////////////////////////////////////This function will draw rectangle on whiteboard and send event to server
...
/////////////////////////////////////This function will draw traiangle on whiteboard and send event to server
	public function triangleDraw()
	{
		...
		if(selectedControl == "circle" || selectedControl =="rect" || selectedControl == "triangle")
...
/////////////////////////////////////////This function will write text on whiteboard and send event to server
...
////////////////////////////////This function will clear all drawing from whiteboard and send event to server
...
///////////////////////////////////////This function will undo drawing on whiteboard and send event to server
...
///////////////////////////////////////This function will redo drawing on whiteboard and send event to server
	public function redoDrawing()
	{

	}

///////////////////////////////////This funtion will insert the object on whiteboard and send event to server
...
///////////////This function will nullify all the objects created at the time of clicking on a control button
